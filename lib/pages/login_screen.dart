...
class LoginScreen extends StatefulWidget {
  final Function(String) onLoginSuccess; // Callback saat login berhasil
...
class _LoginScreenState extends State<LoginScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final iconInnerSize = isTablet ? 60.0 : 50.0;
    ...
    final topSpacing = isLandscape ? 20.0 : (isTablet ? 80.0 : 60.0);
    final bottomSpacing = isLandscape ? 20.0 : 40.0;
